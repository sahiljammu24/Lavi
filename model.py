...
- Voting systems"""
        ...
        # Code templates
        self.code_templates = {
            'python hello world': '''Here's a Python "Hello World" program:
...
You can run this by saving it as `hello.py` and running `python hello.py`''',

            'python function': '''Here's how to create functions in Python:
...
```''',
            ...
            'python loop': '''Here are different types of loops in Python:
